...
class Noten extends db implements Dmlable{
	...
	*/
	...
	public function load($id){
         ...
         * @return array
         *
         * R�ckgabe aller Noten aus der Datenbank von der angegebenen Klasse
         */
...
/*
         ...
         * @return array
         *
         * R�ckgabe der Noten des angegebenen Schuelers als array.
         */
         ...
         * @return integer
         *
         * �bergibt die Durchschnittsnote f�r das gew�hlte Fach f�r den
